        ...
        >
            ...
            <div className="flex items-center gap-2 shrink-0">
                ...
                <Link href={`/vaults/${vault.id}`}>
                    <button className="h-(--touch-target) sm:h-8 rounded-lg border border-black/10 px-4 sm:px-3 text-sm sm:text-xs text-black/45 hover:border-black/20 hover:text-black transition-colors">
                        Details
                    </button>
                </Link>
                <button
                    onClick={() => onSelect(vault)}
                    className="flex h-(--touch-target) sm:h-8 items-center gap-1 rounded-lg bg-black px-4 sm:px-3 text-sm sm:text-xs text-white transition-opacity hover:opacity-75 active:scale-[0.98]"
                >
        ...
        >
            ...
            <div className="flex gap-2">
                <Link href={`/vaults/${vault.id}`} className="flex-1">
                    <button className="h-(--touch-target) sm:h-9 w-full rounded-xl border border-black/10 text-sm sm:text-xs text-black/45 hover:border-black/20 hover:text-black transition-colors active:bg-black/5">
                        Details
                    </button>
                </Link>
                <button
                    onClick={() => onSelect(vault)}
                    className="flex flex-1 h-(--touch-target) sm:h-9 items-center justify-center gap-1 rounded-xl bg-black text-sm sm:text-xs text-white transition-opacity hover:opacity-75 active:scale-[0.98]"
                >
